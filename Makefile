...
terraform_addon_spec = spec/addons/base/terraform/**/*_spec.rb
...
test_template:
	...
	if [ $(VARIANT) = web ]; then \
		...
		bundle exec rspec --pattern="${base_spec}, ${api_spec}, ${base_addon_spec}, ${api_addon_spec}, ${terraform_addon_spec}"; \
	fi;
